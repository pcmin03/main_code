...
from resnet_icnet import resnet50_v1s, resnet101_v1s, resnet152_v1s
...
class ICNet(SegBaseModel):
    ...
    def __init__(self, nclass = 4, backbone='resnet50', pretrained_base=True):
        super(ICNet, self).__init__(nclass,backbone, pretrained_base=pretrained_base)
        self.first = nn.Conv2d(1,3,3,padding=1)
